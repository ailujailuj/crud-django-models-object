...
def write_learners():
    learner1 = Learner(first_name='Andy', last_name='Warhol', dob=date(1928, 8, 6), ocuppation='data_scientist', social_link='https://pt.wikipedia.org/wiki/Andy_Warhol')
    learner1.save()
    learner2 = Learner(first_name='Will', last_name='Smith', dob=date(1968, 9, 25), ocuppation='student', social_link='https://pt.wikipedia.org/wiki/Will_Smith')
    learner2.save()
    learner3 = Learner(first_name='Virginia', last_name='Woolf', dob=date(1882, 1, 25), ocuppation='dba', social_link='https://pt.wikipedia.org/wiki/Virginia_Woolf')
    learner3.save()
